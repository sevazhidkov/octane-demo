      ...
      <div className="navbar flex flex-row md:mb-2 shadow-lg bg-neutral text-neutral-content">
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch">
            ...
            <Link href="/transfer">
              <a className="btn btn-ghost btn-sm rounded-btn">Transfer</a>
            </Link>
            <Link href="/transaction-with-auth">
              <a className="btn btn-ghost btn-sm rounded-btn">Transaction with Auth</a>
            </Link>
            <Link href="/swap">
              <a className="btn btn-ghost btn-sm rounded-btn">Swap</a>
            </Link>

            <Link href="/just-in-time-swap">
              <a className="btn btn-ghost btn-sm rounded-btn">Just-in-time swap</a>
            </Link>
          </div>
        </div>
